...
Windows版のMSI形式のインストーラーファイルTWLogAIAN.msiかMacOS版のTWLogAIAN_dev.pkgをダウンロードしてください。
...
<img src="./images/ja/grok_edit_screen.png" width="600">
...
<img src="./images/ja/log_definition.png" width="600">
