...
![](./images/ja/install_macos_manual.png)
...
![](./images/ja/launch_windows.png)

## MacOS版の起動

MacOSの場合はランチャーなどからお好きな方法で起動してください。

![](./images/ja/launch_macos.png)
...
![](./images/ja/edit_log_source_list.png)

## ログソース編集画面

ログソース（読み込み元）の編集画面は右の図ののような感じです。

![](./images/ja/edit_log_source.png)
...
![](./images/ja/delete_log_source.png)
...
![](./images/ja/log_source_types.png)
...
![](./images/ja/log_source_single_file.png)
...
![](./images/ja/log_source_folder.png)
...
![](./images/ja/log_source_command.png)
...
![](./images/ja/log_source_twsnmp_fc.png)
...
![](./images/ja/log_source_windows_event.png)
...
![](./images/ja/log_search_manual.png)
...
![](./images/ja/log_search_basics.png)
...
![](./images/ja/search_criteria_screen.png)

### 検索履歴

以前に実行した検索文のリストです。選択すれば、検索文へ入力します。右端の削除ボタンでクリアできます。

![](./images/ja/search_history.png)
...
![](./images/ja/search_period_2.png)

- 範囲指定
時間の範囲を指定するモード

![](./images/ja/search_period_1.png)
...
![](./images/ja/anomaly_detection_config.png)
...
![](./images/ja/log_format_access_log.png)

### 抽出データ

ログから抽出したデータをテーブル形式で表示します。項目が多い時には横スクロールできます。

![](./images/ja/log_format_extracted.png)
...
![](./images/ja/log_format_anomaly_score.png)
...
![](./images/ja/report_process_results_manual.png)
...
![](./images/ja/report_timeseries.png)
...
![](./images/ja/report_regression.png)
...
![](./images/ja/report_timeseries_3d.png)
...
![](./images/ja/report_histogram.png)
...
![](./images/ja/report_location_manual.png)
...
![](./images/ja/report_flow_graph.png)
...
![](./images/ja/report_flow_globe.png)
...
![](./images/ja/grok_edit_launch.png)
...
![bg right w:600](./images/ja/grok_edit_screen.png)
...
![bg right w:600](./images/ja/log_definition.png)
