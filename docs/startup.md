...
![](./images/ja/dark_mode_startup.png)


## 言語切替
右上のメニューで画面の表示を英語に切り替えられます。

![](./images/ja/language_switch_startup.png)
...
![](./images/ja/select_workspace.png)
...
![](./images/ja/log_sources_list.png)
...
![](./images/ja/log_loading_config.png)
...
![](./images/ja/indexing_startup.png)
...
![](./images/ja/log_search_startup.png)
...
![](./images/ja/report_process_results_startup.png)
...
![](./images/ja/search_criteria_startup.png)

## レポート

時間範囲や位置情報、IPアドレスから位置情報を抽出する設定にすればレポートも表示できます。

![](./images/ja/report_location_startup.png)
